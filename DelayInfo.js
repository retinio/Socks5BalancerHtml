    ...
    const tableState = {
        formatDurationFunction: {
            s: "formatDurationFunction", f: (time) => {
                const seconds = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(time).seconds();
                const minutes = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(time).minutes();
                const hours = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(time).hours();
                const days = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(time).days();
                const months = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(time).months();
                const years = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(time).years();
                if (years > 0) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var moment_locale_zh_cn_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment/locale/zh-cn.js */ "./node_modules/moment/locale/zh-cn.js");
/* harmony import */ var moment_locale_zh_cn_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment_locale_zh_cn_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var i18n_table_en_US__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! i18n-table/en-US */ "./i18n-table/en-US.ts");
/* harmony import */ var i18n_table_zh_CN__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! i18n-table/zh-CN */ "./i18n-table/zh-CN.ts");
/**
 * Socks5BalancerAsio : A Simple TCP Socket Balancer for balance Multi Socks5 Proxy Backend Powered by Boost.Asio
 * Copyright (C) <2020>  <Jeremie>
 *
...
/******/ })()
;
//# sourceMappingURL=DelayInfo.js.map